...
class DrugInteractionDataset(Dataset):
    def __init__(self, csv_file, categories_file=None, balance_mode="none"):
        ...
        self.embedding_cols = ['embedding1_1', 'embedding2_1','embeding1_2','embeding2_2']
    ...
    def __getitem__(self, idx):
        ...
        embedding1 = np.array(eval(self.data.iloc[idx]['embedding1_1']))
        embedding2 = np.array(eval(self.data.iloc[idx]['embedding1_2']))
        embedding3 = np.array(eval(self.data.iloc[idx]['embedding2_1']))
        embedding4 = np.array(eval(self.data.iloc[idx]['embedding2_2']))
        
        features = np.concatenate((embedding1, embedding3,embedding2, embedding4), axis=None)
